...
label(dataset_thesis$comorbidities) <- "Chronic diseases"

x <-table1(~ sex+ age + level_hi , data= dataset_thesis ,caption="Variables distrubution")

kableExtra::kable_styling(t1kable(x), bootstrap_options="responsive", stripe_color="white")%>% 
...
kableExtra::kable_styling(t1kable(y), bootstrap_options="responsive", stripe_color="white")%>% 
column_spec(1,width = "8cm", bold = F)
```
...
kableExtra::kable_styling(t1kable(a), bootstrap_options="responsive", stripe_color="white")%>% 
column_spec(1,width = "8cm", bold = F)
```
